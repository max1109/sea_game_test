...
public class Util {
	...
	public static String PATH =  Environment.getExternalStorageDirectory().getPath() + "/lab702";
	public static String USER_INFO_PATH = "/info.xml";
	
	public static Data USER_DATA = null;
